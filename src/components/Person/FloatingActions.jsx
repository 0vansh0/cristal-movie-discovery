...
export default function CareerStats({
  ...
  const safeStats = {
    totalCredits:
      Number(
        careerStats.totalCredits
      ) || 0,

    actingCredits:
      Number(
        careerStats.actingCredits
      ) || 0,

    crewCredits:
      Number(
        careerStats.crewCredits
      ) || 0,

    movieCredits:
      Number(
        careerStats.movieCredits
      ) || 0,

    tvCredits:
      Number(
        careerStats.tvCredits
      ) || 0,

    directedCredits:
      Number(
        careerStats.directedCredits
      ) || 0,

    producedCredits:
      Number(
        careerStats.producedCredits
      ) || 0,

    writtenCredits:
      Number(
        careerStats.writtenCredits
      ) || 0,

    cinematographyCredits:
      Number(
        careerStats.cinematographyCredits
      ) || 0,
  };
  ...
  /* =======================================================
     ...
     Only used for things such as:
     - average rating
     - highest rated title
     - career dates
     
     The actual role statistics above come
     from personService.
  ======================================================= */
   ...
   *
   * This is only a visual normalization.
   */
      ...
      {popularity > 0 && (
        ...
        >
          ...
          <p
            ...
            "
          >
            TMDB popularity is a dynamic
            score and should not be
